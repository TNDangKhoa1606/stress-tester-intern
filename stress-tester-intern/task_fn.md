...
* [ ] Chạy được demo API local, **có ảnh chụp xác nhận**.
* [ ] `docs/endpoints.md` đầy đủ thông tin endpoint.
* [ ] `docs/test_plan.md` (**mục tiêu, KPI/SLO, mô hình tải, an toàn**).
...
Bạn muốn mình tách riêng thành nhiều file khởi tạo sẵn (ví dụ `docs/test_plan.md`, `docs/endpoints.md`, `scripts/run_all.sh` rỗng có khung) để bạn commit vào repo ngay không?
```
